...
*speciesAb <- "enter species abbreviation"
*range <- paste0("littleRange_", speciesAb)
*title <- expression(paste(italic("add species name here"), " occurrences"))
...
```{r}
save.image('./03 - Modeling Workspace - Enter Sp Cleaning')
