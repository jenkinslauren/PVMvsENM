...
plot(recordsSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus nigra '), 'occurrences (BIEN) thinned')))
if (exists("water")) {
...
plot(bgTestSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus nigra '), 'background sites')))
