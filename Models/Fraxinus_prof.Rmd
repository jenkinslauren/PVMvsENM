...
plot(recordsSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus profunda '), 'occurrences (BIEN) thinned')))
if (exists("water")) {
...
plot(bgTestSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus profunda '), 'background sites')))
