---
title: "Fraxinus latifolia model"
...
sp <- 'Fraxinus latifolia'
species <- 'fraxinus_latifolia'
speciesAb <- 'FraxLati'
...
plot(recordsSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus latifolia '), 'occurrences (BIEN) thinned')))
if (exists("water")) {
