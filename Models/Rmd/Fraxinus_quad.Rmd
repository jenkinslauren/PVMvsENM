---
title: "Fraxinus quadrangulata model"
...
plot(recordsSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus quadrangulata '), 'occurrences (BIEN) thinned')))
if (exists("water")) {
...
The last raster in the output will be THE mess map. The first three is one per predictor.
