---
title: "Fraxinus caroliniana model"
...
plot(recordsSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus caroliniana '), 'occurrences (BIEN) thinned')))
if (exists("water")) {
...
plot(bgTestSp, pch = 16, cex = 0.5, col = "red", 
     main = substitute(paste(italic('Fraxinus caroliniana '), 'background sites')))
