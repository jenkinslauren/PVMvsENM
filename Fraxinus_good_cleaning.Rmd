---
title: "Fraxinus gooddingii cleaning"
...
species <- "fraxinus gooddingii"
speciesAb <- "Frax_Good"
range <- littleRange_FraxGood
title <- expression(paste(italic("Fraxinus gooddingii"), " occurrences"))
```
