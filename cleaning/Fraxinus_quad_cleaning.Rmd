---
title: "Fraxinus quadrangulata cleaning"
...
speciesAb <- "Frax_Quad"
range <- littleRange_FraxQuad
title <- expression(paste(italic("Fraxinus quadrangulata"), " occurrences"))
```
...
Cleaning *Fraxinus quadrangulata*.
