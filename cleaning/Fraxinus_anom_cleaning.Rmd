---
title: "Fraxinus_anomala_cleaning"
...
speciesAb <- "Frax_Anom"
range <- littleRange_FraxAnom
title <- expression(paste(italic("Fraxinus anomala"), " occurrences"))
```
...
```
4 records removed due to precision > 1,000 m. 
...
# visualize using ggplot sf objects before buffering
ggplot(data = world) +
  theme_bw() +
  geom_sf(fill = "white") +
