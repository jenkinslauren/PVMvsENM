---
title: "Fraxinus papillosa cleaning"
...
species <- "fraxinus papillosa"
speciesAb <- "Frax_Papi"
range <- littleRange_FraxPapi
title <- expression(paste(italic("Fraxinus papillosa"), " occurrences"))
```
