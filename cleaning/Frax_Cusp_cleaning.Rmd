---
title: "Fraxinus cuspidata cleaning"
...
species <- "fraxinus cuspidata"
speciesAb <- "Frax_Cusp"
range <- littleRange_FraxCusp
title <- expression(paste(italic("Fraxinus cuspidata"), " occurrences"))
```
